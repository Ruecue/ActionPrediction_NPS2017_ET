function rb_PCA14_TM_BM_LookingTimes_Percentages(direc, datatotal, timing, out,incstim)
%LOOKING TIME PCA 14
...
for subj=1:subjtotal
    clear LookingTime
    clearvars -except LT_OutDataPerVideo incstim x_all subj AOI subjtotal direc datatotal timing out LookingTime_AllSubs Table_LookingTime_AllSubs Mouth_LookingTime_AllSubs  Mouth_LookingTime_TrialNumber  Table_LookingTime_TrialNumber  LookingTime_TrialNumber
...
%Save Trial Number
save([out, 'Looking\VideosIncluded'],'incstim')
